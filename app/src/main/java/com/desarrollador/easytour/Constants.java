...
public class Constants {
    ...
    public static final long lIntervalo_Reconocimiento_Actividad = 0;
    public static final long lTiempo_Intervalo = 1000 * 60;// * 5;
    public static final long lActualizar_Intervalo_Fastest = lTiempo_Intervalo / 2;
